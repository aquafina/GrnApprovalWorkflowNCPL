...
<?oracle-xsl-mapper
  ...
  <!-- GENERATED BY ORACLE XSL MAPPER 11.1.1.7.8(build 150622.2350.0222) AT [FRI MAY 06 14:42:21 PKT 2016]. -->
?>
    ...
    <top:XxReceiptApproverHistoryCollection>
      <xsl:for-each select="/ns1:ReadReceiptDataOutputCollection/ns1:ReadReceiptDataOutput">
        <top:XxReceiptApproverHistory>
          ...
          <top:historyId>
            <xsl:value-of select='oraext:sequence-next-val("xx_receipt_apr_history_seq","jdbc:oracle:thin:apps/mskiz145@192.168.0.30:1526:icterp")'/>
          </top:historyId>
        </top:XxReceiptApproverHistory>
      </xsl:for-each>
    </top:XxReceiptApproverHistoryCollection>
