    ...
    <top:XxReceiptApproverHistoryCollection>
      <xsl:for-each select="/ns1:ReadReceiptDataOutputCollection/ns1:ReadReceiptDataOutput">
        <top:XxReceiptApproverHistory>
          ...
          <top:historyId>
            <xsl:value-of select='oraext:sequence-next-val("xx_receipt_apr_history_seq","jdbc:oracle:thin:apps/mskiz145@192.168.0.80:1523:erpclone")'/>
          </top:historyId>
        </top:XxReceiptApproverHistory>
      </xsl:for-each>
    </top:XxReceiptApproverHistoryCollection>
