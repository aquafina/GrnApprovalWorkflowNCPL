...
<?oracle-xsl-mapper
  ...
  <mapTargets>
    <target type="WSDL">
      <schema location="../../../../../../Sarmad%20Data/GRNApproval/Paperless/GrnApprovalWorkflow/GrnApproval/ResetLineProcessedFlag.wsdl"/>
      <rootElement name="RcvShipmentLinesCollection" namespace="http://xmlns.oracle.com/pcbpel/adapter/db/top/ResetLineProcessedFlag"/>
    </target>
  </mapTargets>
  <!-- GENERATED BY ORACLE XSL MAPPER 11.1.1.7.0(build 140919.1004.0161) AT [THU JUL 28 11:28:12 PKT 2016]. -->
?>
<xsl:stylesheet version="1.0"
                ...
                xmlns:tns="http://xmlns.oracle.com/pcbpel/adapter/db/GrnApprovalWorkflow/GrnApproval/ResetLineProcessedFlag"
                ...
                xmlns:top="http://xmlns.oracle.com/pcbpel/adapter/db/top/ResetLineProcessedFlag"
                ...
                exclude-result-prefixes="xsi xsl client ns2 plnk wsdl xsd ns1 tns top xp20 bpws bpel bpm ora socket mhdr oraext dvm hwf med ids xdk xref bpmn ldap">
  <xsl:template match="/">
