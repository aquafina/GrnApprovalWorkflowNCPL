...
<?oracle-xsl-mapper
  ...
  <mapSources>
    <source type="WSDL">
      <schema location="../../../../../Development%20Workspace/BPM/GrnApprovalWorkflow/GrnApproval/BP_UpdateLineDisApp.wsdl"/>
      <rootElement name="ReadReceiptDataOutputCollection" namespace="http://xmlns.oracle.com/pcbpel/adapter/db/ReadReceiptData"/>
    </source>
  </mapSources>
  <mapTargets>
    <target type="WSDL">
      <schema location="../../../../../Development%20Workspace/BPM/GrnApprovalWorkflow/GrnApproval/UpdateLineDISAPPROVED.wsdl"/>
