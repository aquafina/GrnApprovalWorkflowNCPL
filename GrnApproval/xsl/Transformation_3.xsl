...
<?oracle-xsl-mapper
  ...
  <mapTargets>
    <target type="WSDL">
      ...
      <rootElement name="XxReceiptApproverHisrotyCollection" namespace="http://xmlns.oracle.com/pcbpel/adapter/db/top/SaveApprover"/>
    </target>
  </mapTargets>
  <!-- GENERATED BY ORACLE XSL MAPPER 11.1.1.7.8(build 150622.2350.0222) AT [THU JAN 21 13:36:02 PKT 2016]. -->
?>
    ...
    <top:XxReceiptApproverHisrotyCollection>
      <xsl:for-each select="/ns1:ReadReceiptDataOutputCollection/ns1:ReadReceiptDataOutput">
        <top:XxReceiptApproverHisroty>
          ...
          <top:historyId>
            <xsl:value-of select='oraext:sequence-next-val("xx_receipt_apr_history_seq","jdbc:oracle:thin:apps/mskiz145@192.168.0.30:1528:erptest7")'/>
          </top:historyId>
        </top:XxReceiptApproverHisroty>
      </xsl:for-each>
    </top:XxReceiptApproverHisrotyCollection>
